This folder contains SQL scripts used to create the relational database structure.
...
The schema is designed for OLTP workloads and supports triggers, stored procedures, and role-based security.
